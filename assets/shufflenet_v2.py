...
from shuffle_block import *

class ShuffleNet_v2_face(nn.Module):
    """ShuffleNet-v2 for face recognition"""
    ...
    def __init__(self, scale, num_features, dropout=0, fp16=False, is_se=False, is_res=False) -> object:
        super(ShuffleNet_v2_face, self).__init__()
        ...
        self.conv2 = BN_Conv2d(self.chnls[0], self.chnls[0], 3, 2, 1)
        ...
        self.fc = nn.Linear(self.chnls[4], num_features)
    ...
    def __make_body(self):
        return nn.Sequential(
            self.conv1, self.conv2,  self.stage2, self.stage3,
